...
# Install
Create a `catkin_ws`. Into the `src` folder clone [octomap](https://github.com/OctoMap/octomap), [octomap_msgs](git@github.com:OctoMap/octomap_msgs.git), and [ros_numpy](https://github.com/eric-wieser/ros_numpy).
